...
FROM uitvoeringen
WHERE begindatum < CAST('2021-01-01' AS date) AND begindatum >= CAST('2020-01-01' AS date) AND cursus IN (SELECT code
                                                                                                          FROM cursussen
                                                                                                          WHERE type = 'BLD')
...
SELECT cursus, begindatum, (SELECT COUNT(*)
                            FROM inschrijvingen
...
WHERE NOT EXISTS (SELECT *
                  FROM uitvoeringen
                  WHERE uitvoeringen.docent = m.mnr)
