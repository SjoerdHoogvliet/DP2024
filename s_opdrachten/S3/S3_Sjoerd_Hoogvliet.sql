...
FROM uitvoeringen u
INNER JOIN cursussen c ON u.cursus = c.code
...
SELECT cursist.naam "cursist", docent.naam "docent"
FROM inschrijvingen i
INNER JOIN medewerkers cursist ON i.cursist = cursist.mnr
NATURAL JOIN uitvoeringen u
...
SELECT m.naam
FROM inschrijvingen i
INNER JOIN medewerkers m ON i.cursist = m.mnr
WHERE i.cursus = 'S02' AND i.begindatum = CAST('2019-04-12' AS date)
